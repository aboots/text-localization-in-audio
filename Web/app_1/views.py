...
def ping_template(request):
    return render(request, "ping_fa.html", {"time": time.time()})


def search(request):
    return render(request, "search_fa.html")
...
def search_submit(request):
    ...
    form.save()
    return render(request, "waiting_fa.html", {"id": form.instance.id})
...
def results(request, id):
    ...
    return render(request, "results_fa.html", context)
